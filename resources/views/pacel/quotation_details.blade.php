        ...
        <div class="row">
            ...
            <div class="col-12 col-md-12 col-lg-12">
               ...
               <div class="col-lg-10">
                 ...
                 <a class="btn btn-xs btn-primary"  onclick="return confirm('Are you sure?')"  href="{{ route('pacel_quotation.edit', $purchases->id)}}"  title="" > Edit </a>          
              <a class="btn btn-xs btn-info"  title="Convert to Invoice" onclick="return confirm('Are you sure? you want to convert Quotation To Invoice')"  href="{{ route('pacel.approve', $purchases->id)}}" title="" >Convert to Invoice </a>
                @endif
