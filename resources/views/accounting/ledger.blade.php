...
<!-- Modal -->
  <div class="modal inmodal show" id="myModal" tabindex="-1" role="dialog" aria-hidden="true">
                          <div class="modal-dialog"><div class="modal-dialog" role="document">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="formModal">Add Loading Expenses<h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">×</span>
            </button>
        </div>
        {{ Form::open(['url' => url('loadingexpenses')]) }}
       @method('POST')
...
<tr>
  ...
  <tr>
                        <td colspan="5" style="text-align: left"><b>Other Income Cost</b></td>
                    </tr>
  <?php  
foreach($income as $account_class_modal){
foreach($account_class_modal->groupAccount  as $group_modal) {  
...
else if($key->account_codes == 2206){
?>
<thead>
                       <tr>
                   <th>Account Name</th>
...
<tr>
                        <td >
                            <b>Total Other Income Cost</b></td>
                       <td></td>
                             <td>{{ number_format(abs($total_debit_other_income_balance_deff ),2) }}</td>
                                <td>{{ number_format(abs($total_credit_other_income_balance_deff ),2) }}</td>
       <td></td>
                    </tr> 
 <tr>
                        <td colspan="5" style="text-align: left"><b>Financial Cost</b></td>
