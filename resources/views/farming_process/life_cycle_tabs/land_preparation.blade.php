<div class="tab-pane fade @if($type =='view-preparation' || $type =='edit-preparation') active show  @endif" id="tab1" role="tabpanel" aria-labelledby="tab1">
    <div class="card">
        ...
        <div class="card-body">
            <ul class="nav nav-tabs" id="myTab2" role="tablist">
                <li class="nav-item">
                    <a class="nav-link @if($type =='view-preparation')active show @endif" id="home-tab2" data-toggle="tab"
                        href="#home2" role="tab" aria-controls="home"
                        aria-selected="true">{{__('farming.preparation_list')}}
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link @if($type =='edit-preparation') active show @endif" id="profile-tab2" data-toggle="tab"
            ...
            <div class="tab-content tab-bordered" id="myTab3Content">
                <div class="tab-pane fade @if($type =='view-preparation') active show @endif" id="home2" role="tabpanel"
                ...
                <div class="tab-pane fade @if($type =='edit-preparation') active show @endif" id="profile2" role="tabpanel"
                                ...
                                <div class="col-sm-12 ">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <input type="hidden" name="type" class="form-control" id="type" value="preparation"
                                                placeholder="">
                                                <input type="hidden" name="id" class="form-control" id="type" value="{{$id}}"
                                                placeholder="">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <button type="button" name="add" class="btn btn-success btn-xs add"><i
                                                class="fas fa-plus">{{__('farming.add')}} {{__('farming.preparation_cost')}}</i></button><br>
                                        <br>
