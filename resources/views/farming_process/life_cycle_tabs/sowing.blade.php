<div class="tab-pane fade @if($type =='view-sowing' || $type =='edit-sowing') active show  @endif" id="tab2" role="tabpanel" aria-labelledby="tab2">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="tab-content tab-bordered" id="myTab3Content">
                <div class="tab-pane fade @if($type =='view-sowing') active show @endif" id="home2" role="tabpanel"
                ...
                <div class="tab-pane fade @if($type =='edit-sowing') active show @endif" id="profile2" role="tabpanel"
