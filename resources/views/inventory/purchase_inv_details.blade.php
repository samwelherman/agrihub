                        ...
                        <ul class="nav nav-tabs" id="myTab2" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="home-tab2" data-toggle="tab" href="#about" role="tab"
                                    aria-selected="true">Purchase Inventory Details</a>
                            </li>
                            @if($purchases->status != 0 && $purchases->status != 4)
                            <li class="nav-item">
                                <a class="nav-link" id="profile-tab2"
                                    href="{{ route('inventory.pay',$purchases->id)}}" role="tab"
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="profile-tab2"
                                    href="{{ route('inv_pdfview',['download'=>'pdf','id'=>$purchases->id]) }}" role="tab"
                                    aria-selected="false">
                                    Download PDF</a>
                            ...
                            <li class="nav-item">                         
                                <a class="nav-link"
                                    ...
                                    href="{{ route('purchase_inventory.edit', $purchases->id)}}">Edit </a>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            title="Edit" onclick="return confirm('Are you sure?')"
                                            href="{{ route('inventory_payment.edit', $row->id)}}"><i
